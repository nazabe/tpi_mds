...
import 'react-datepicker/dist/react-datepicker.css'; // ¡Importa este archivo CSS!
...
const servicesData: Service[] = [
  ...
  { id: 2, name: "Masaje Descontracturante", duration: "XX minutos", price: "$XXXXX,XX", icon: <FaHeart /> },
  { id: 3, name: "Masaje con Piedras Calientes", duration: "XX minutos", price: "$XXXXX,XX", icon: <FaHeart /> },
  { id: 4, name: "Masaje Circulatorio", duration: "XX minutos", price: "$XXXXX,XX", icon: <FaHeart /> },

  // Servicios Individuales - Belleza
  { id: 5, name: "Lifting de Pestaña", duration: "XX minutos", price: "$XXXXX,XX", icon: <FaHeart /> },
  { id: 6, name: "Depilación Facial", duration: "XX minutos", price: "$XXXXX,XX", icon: <FaHeart /> },
  { id: 7, name: "Belleza de Manos y Pies", duration: "XX minutos", price: "$XXXXX,XX", icon: <FaHeart /> },

  // Servicios Individuales - Tratamientos Faciales
  { id: 8, name: "Punta de Diamante Microexfoliación", duration: "XX minutos", price: "$XXXXX,XX", icon: <FaHeart /> },
  { id: 9, name: "Limpieza Profunda + Hidratación", duration: "XX minutos", price: "$XXXXX,XX", icon: <FaHeart /> },
  { id: 10, name: "Crio Frecuencia Facial", duration: "XX minutos", price: "$XXXXX,XX", icon: <FaHeart /> },
          ...
          <div className={styles.stepContainer}> {/* Contenedor para aplicar margen inferior */}
              ...
              {/* Botón para pasar al Paso 3 - Visible SOLO si Fecha Y Hora están seleccionados */}
               {selectedDate !== null && selectedTime !== null && (
                   ...
                   // Pero la imagen de ejemplo muestra los botones abajo del todo.
